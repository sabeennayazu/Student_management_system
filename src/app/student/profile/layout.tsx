...
import { MoreVertical, User, Award, BookOpen, FolderOpen, FileText, MessageSquare } from "lucide-react";
...
const tabs = [
	...
	{ name: "Instructor Feedback", href: "/student/profile/instructor-feedback", icon: MessageSquare },
];
...
export default function ProfileLayout({ children }: { children: ReactNode }) {
	...
	const effectivePath =
		pathname === "/student/profile" ? "/student/profile/personal-info" : pathname;

	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/40">
			<div className="max-w-6xl mx-auto px-4 py-8">
				{/* Header Section */}
				<div className="bg-gradient-to-r from-white to-blue-50/50 rounded-3xl shadow-sm border border-blue-100/50 overflow-hidden mb-8 backdrop-blur-sm">
					<div className="p-8">
						<div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
							...
							<div className="flex-1 text-center lg:text-left pt-10">
								<h1 className="text-3xl font-light text-gray-900 mb-2 ">Sabin Nayaju</h1>
							</div>
